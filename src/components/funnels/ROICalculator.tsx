...
export default function ROICalculator() {
  ...
  // JLAW System Projection (assuming we double their conversion and close rate through automation)
  const projConversionRate = Math.min(conversionRate * 2.5, 15); // JLAW projection
  const projCloseRate = Math.min(closeRate * 1.5, 60); // JLAW projection
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          <span className="text-[var(--color-gold)] font-bold tracking-widest uppercase text-sm mb-3 block flex items-center justify-center gap-2">
            <Calculator size={16} /> Interactive ROI Calculator
          </span>
          <h2 className="text-4xl lg:text-5xl font-extrabold mb-4 text-white">
            See How Much Revenue You're <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-400">Losing</span>
          </h2>
          <p className="text-gray-400 max-w-2xl mx-auto text-lg font-light">
            Enter your current numbers below to see what happens when you install a proper Lead Generation System.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-5 space-y-8 glass-card p-8 rounded-3xl border border-gray-800 shadow-2xl bg-black/40">
            <div className="space-y-6">
              ...
              {/* Variable 1: Monthly Visitors */}
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <label className="text-sm font-bold text-gray-300 flex items-center gap-2">
                    <Users size={16} className="text-[var(--color-teal)]" /> Monthly Website Visitors
                  </label>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <label className="text-sm font-bold text-gray-300 flex items-center gap-2">
                    <Target size={16} className="text-[var(--color-teal)]" /> Website Conversion Rate
                  </label>
              ...
              {/* Variable 3: Lead Close Rate */}
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <label className="text-sm font-bold text-gray-300 flex items-center gap-2">
                    <TrendingUp size={16} className="text-[var(--color-teal)]" /> Lead Close Rate
                  </label>
              ...
              {/* Variable 4: Average Job Value */}
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <label className="text-sm font-bold text-gray-300 flex items-center gap-2">
                    <DollarSign size={16} className="text-[var(--color-teal)]" /> Average Job Value
                  </label>
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            <div className="grid sm:grid-cols-2 gap-6 mb-8">
              ...
              <div className="bg-[#111A20] p-6 rounded-2xl border border-gray-800">
                <h3 className="text-sm font-bold text-gray-500 uppercase tracking-wider mb-4">Your Current System</h3>
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-white font-bold">{customers} /mo</span>
                  </div>
              ...
              <div className="bg-gradient-to-br from-[#0E4D55]/20 to-black p-6 rounded-2xl border border-[var(--color-teal)]/50 shadow-[0_0_30px_rgba(14,77,85,0.2)] relative overflow-hidden">
                <div className="absolute top-0 right-0 bg-[var(--color-teal)] text-white text-[10px] font-bold px-3 py-1 rounded-bl-lg uppercase tracking-wider">JLAW 360 System</div>
                <h3 className="text-sm font-bold text-[var(--color-teal)] uppercase tracking-wider mb-4">With Optimized Funnel</h3>
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-gray-300">Monthly Leads <span className="text-xs text-[var(--color-teal)] ml-1">(↑ {projConversionRate}%)</span></span>
                    <span className="text-white font-bold">{projLeads}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-300">New Clients <span className="text-xs text-[var(--color-teal)] ml-1">(↑ {projCloseRate}%)</span></span>
                    <span className="text-white font-bold">{projCustomers} /mo</span>
                  </div>
                  <div className="pt-4 border-t border-[var(--color-teal)]/30">
                    <div className="flex justify-between items-end">
                      <span className="text-[var(--color-teal)] text-sm font-bold">Monthly Revenue:</span>
            ...
            >
              <p className="text-gray-300 mb-2 font-medium">By fixing your leaky funnel, you could generate an additional</p>
              ...
              <p className="text-gray-400 mt-2 tracking-wide uppercase text-sm font-bold">In Missed Revenue Per Year</p>
              ...
              <button className="mt-8 neon-btn-gold px-8 py-4 rounded-full font-bold text-sm w-full sm:w-auto inline-flex items-center justify-center gap-3">
                Fix My Lead Flow <ArrowRight size={18} />
              </button>
            </motion.div>
          </div>
        </div>
