  ...
  return (
    <div className="min-h-screen bg-[#020507] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <Link href="/" className="absolute top-8 left-8 text-gray-400 hover:text-white flex items-center gap-2 transition-colors z-20">
        <ArrowLeft size={20} />
        <span className="text-sm font-semibold uppercase tracking-widest font-mono">Return</span>
      </Link>
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="cyber-glass rounded-2xl p-8 sm:p-10 shadow-2xl animate-fade-in-up border border-gray-800">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-white tracking-tight">Client Portal Access</h1>
            <p className="text-gray-400 text-sm mt-2 text-center">Enter your clearance credentials to view your live data dashboard.</p>
          </div>

          <form className="space-y-6">
            <div className="space-y-2">
              <label htmlFor="email" className="text-xs font-mono uppercase tracking-widest text-[#277E95]">Email Authorization</label>
              <input 
                id="email" 
                name="email" 
                type="email" 
            ...
            <div className="space-y-2">
              <label htmlFor="password" className="text-xs font-mono uppercase tracking-widest text-[#277E95]">Secure Passkey</label>
              <input 
                id="password" 
                name="password" 
                type="password" 
        ...
        <div className="mt-8 text-center flex flex-col items-center gap-2">
           ...
           <p className="text-[10px] font-mono text-gray-600 uppercase tracking-[0.2em]">Secure Connection Established</p>
        </div>
      </div>
    </div>
  )
